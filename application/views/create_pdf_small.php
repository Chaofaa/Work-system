    <div class="main">
      ...
      <div class="table-responsive">
        <form action="<?= base_url(); ?>invoice/createPDFsmall" method="post" />  
                    ...
                    <tbody>
                        ...
                        <? if(isset($atskaite)){ ?>
                            <tr>
                                <td><input type="text" name="number[]" class="form-control p_nr" /></td>
                                <td>
                                    <input type="text" name="lieta[]" class="form-control" placeholder="Lieta" value="Juridiskie pakalpojumi" />
                                    <input type="text" style="width:50%; float:left;" name="datums[]" class="form-control datepicker" placeholder="No" value="<?= ((isset($filter_data['no-datums']))?$filter_data['no-datums']:''); ?>" /> 
                                    <input type="text" style="width:50%; float:left;" name="datums-lidz[]" class="form-control datepicker" placeholder="Lidz" value="<?= ((isset($filter_data['lidz-datums']))?$filter_data['lidz-datums']:''); ?>" />       
                                    <input type="text" name="apraksts[]" placeholder="Apraksts" class="form-control" />
                                </td>
                                <td><input type="text" name="type[]" class="form-control p_merv" value="stunda" /></td>
                                <td><input type="text" name="time[]" class="form-control p_count" value="<?= ((isset($total_time))?$total_time:''); ?>" /></td>
                                <td><input type="text" name="cena[]" class="form-control p_price" /></td>
                                <td><input type="text" name="sum[]" class="form-control p_total_price" /></td>
                                <td><span style="margin-left:20px;" class="glyphicon glyphicon-trash pointer_"></span></td>
                            </tr>
