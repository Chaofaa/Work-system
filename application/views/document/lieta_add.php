    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      ...
      <div class="table-responsive">
      	<form role="form" class="add_user" method="post" action="<?= base_url(); ?>lieta/add">
          ...
          <div class="form-group">
      			...
      			<input type="text" class="form-control" name="name" id="client" placeholder="Ievadi Nosaukums" required />
      		</div>
      		<div class="form-group">
      			<label for="comment">Info</label>
      			<textarea name="comment" id="editor" class="form-control" placeholder="Ievadi Info"></textarea>
      		</div>
