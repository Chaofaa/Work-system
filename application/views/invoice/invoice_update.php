    <div class="main">
      ...
      <div class="table-responsive">
        <form action="<?= base_url(); ?>invoice/updateBig/<?= $this->uri->segment(3); ?>" method="post" />  
        ...
        <div class="well well-lg" style="width:900px"> 
                    ...
                    <tbody>
                        ...
                        <? if(isset($data_list)){ ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="lieta[]" class="form-control" value="<?= $v->lieta; ?>" placeholder="Lieta" />
                                    <input type="text" name="datums[]" class="form-control datepicker" value="<?= $v->datums; ?>" placeholder="Datums" />
                                    <input type="hidden" name="datums-lidz[]" value="" />
                                    <input type="text" name="apraksts[]" class="form-control" value="<?= $v->apraksts; ?>" placeholder="Apraksts" />
                                </td>
            ...
            <div class="row">
                <div class="left-block">
                        Summa vārdiem (EUR):divi tūkstoši deviņi simti pieci EUR, 21 centi.<br /><br /> 
